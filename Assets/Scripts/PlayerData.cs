...
public class PlayerData
{
    ...
    static public void Create()
    {
        ...
        m_Instance.saveFile = Application.persistentDataPath + "/savejson.bin";
    ...
    public void Read()
    {
        ...
        characterAccessories = data.characterAccessories;
        themes = data.themes;
        usedTheme = data.usedTheme;
        premium = data.premium;
        highscores = data.highscores;
        missions = data.missions;
        previousName = data.previousName;
        masterSFXVolume = data.masterSFXVolume;
        musicVolume = data.musicVolume;
        masterSFXVolume = data.masterSFXVolume;
        ftueLevel = data.ftueLevel;
        rank = data.rank;
        ...
        //if (ver >= 12)
        //{
        //    Debug.Log("Read tutorialDone");
        //    tutorialDone = r.ReadBoolean();
        //}
        //Debug.Log($"tutorialDone = {tutorialDone}");
        //r.Close();
    }
    ...
    public void Save()
    {
        ...
        //      Debug.Log($"Save tutorialDone = {tutorialDone}");
